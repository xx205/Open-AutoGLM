...
# NOTE: The "必须遵循的规则" section is intentionally disabled (not appended to SYSTEM_PROMPT).
# You can re-enable it later by concatenating this block back into the system prompt.
STRICT_RULES = """
必须遵循的规则：
